...
QT_MOC_LITERAL(3, 26, 14) // "ItemDeSelected"
    ...
    "QRootCanvas\0ItemSelected\0\0ItemDeSelected"
};
...
void QRootCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QRootCanvas::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QRootCanvas::ItemSelected)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (QRootCanvas::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&QRootCanvas::ItemDeSelected)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void QRootCanvas::ItemSelected()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void QRootCanvas::ItemDeSelected()
{
