...
QT_MOC_LITERAL(9, 131, 11), // "std::string"
QT_MOC_LITERAL(10, 143, 1), // "s"
QT_MOC_LITERAL(11, 145, 18), // "std::vector<float>"
QT_MOC_LITERAL(12, 164, 1), // "c"
QT_MOC_LITERAL(13, 166, 18) // "handle_root_events"

    },
    "QMainCanvas\0ItemSelected\0\0ItemDeSelected\0"
    "DrawCanvas\0std::vector<TH1I*>\0"
    "std::vector<std::vector<int> >\0"
    "std::vector<APVAddress>\0addr\0std::string\0"
    "s\0std::vector<float>\0c\0handle_root_events"
};
...
void QMainCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->DrawCanvas((*reinterpret_cast< const std::string(*)>(_a[1])),(*reinterpret_cast< const std::vector<float>(*)>(_a[2]))); break;
